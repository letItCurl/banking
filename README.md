...
> active record's transaction

## ActiveRecord workout !


## FROM

Chris GoRails videos :
[ Atomic Updates And Performance with ActiveRecord Transactions](https://gorails.com/episodes/activerecord-transactions?autoplay=1)
